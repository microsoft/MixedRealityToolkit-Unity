...
{
    internal class SynchronizedCamera : SynchronizedComponent<CameraService, SynchronizedCamera.ChangeType>
    {
        [Flags]
        ...
        private Camera synchronizedCamera;
        ...
        protected override void Awake()
        {
            ...
            this.synchronizedCamera = GetComponent<Camera>();
        }
        ...
        protected override ChangeType CalculateDeltaChanges()
        {
            ...
            CameraProperties newProperties = new CameraProperties(this.synchronizedCamera);
