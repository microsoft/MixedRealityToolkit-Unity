...
{
    internal class ImageBroadcaster : ComponentBroadcaster<ImageService, ImageBroadcaster.ChangeType>
    {
        ...
        protected override ChangeType CalculateDeltaChanges()
        {
            ...
            MaterialsBroadcaster.UpdateMaterials(null, TransformBroadcaster.PerformanceParameters, new Material[] { imageComp.materialForRendering }, out areMaterialsDifferent);
        ...
        protected override void SendDeltaChanges(IEnumerable<SocketEndpoint> endpoints, ChangeType changeFlags)
        {
            ...
            {
                MaterialsBroadcaster.SendMaterialPropertyChanges(endpoints, null, TransformBroadcaster.PerformanceParameters, m =>
                {
