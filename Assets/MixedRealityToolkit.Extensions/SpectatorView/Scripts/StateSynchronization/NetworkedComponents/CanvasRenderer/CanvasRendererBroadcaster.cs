...
{
    internal class CanvasRendererBroadcaster : ComponentBroadcaster<CanvasRendererService, CanvasRendererBroadcaster.ChangeType>
    {
        [Flags]
        ...
        private CanvasRenderer canvasRendererBroadcaster;
        ...
        protected override void Awake()
        {
            ...
            this.canvasRendererBroadcaster = GetComponent<CanvasRenderer>();
        }
