...
{
    internal class CanvasGroupBroadcaster : ComponentBroadcaster<CanvasGroupService, CanvasGroupBroadcaster.ChangeType>
    {
        [Flags]
        ...
        private CanvasGroup canvasGroupBroadcaster;
        ...
        protected override void Awake()
        {
            ...
            this.canvasGroupBroadcaster = GetComponent<CanvasGroup>();
        }
        ...
        protected override ChangeType CalculateDeltaChanges()
        {
            ...
            CanvasGroupProperties newValues = new CanvasGroupProperties(canvasGroupBroadcaster);
