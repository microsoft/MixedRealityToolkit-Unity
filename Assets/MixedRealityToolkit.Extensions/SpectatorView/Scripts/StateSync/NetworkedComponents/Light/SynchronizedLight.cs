...
namespace Microsoft.MixedReality.Toolkit.Extensions.Experimental.SpectatorView
{
    ...
    /// </summary>
    internal class SynchronizedLight : SynchronizedComponent<LightService, SynchronizedLight.ChangeType>
    {
        [Flags]
        ...
        private Light synchronizedLight;
        ...
        protected override void Awake()
        {
            ...
            this.synchronizedLight = GetComponent<Light>();
        }
        ...
        protected override ChangeType CalculateDeltaChanges()
        {
            ...
            LightProperties newProperties = new LightProperties(this.synchronizedLight);
