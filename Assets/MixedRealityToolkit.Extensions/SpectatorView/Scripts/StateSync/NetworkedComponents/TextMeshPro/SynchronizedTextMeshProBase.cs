...
{
    internal abstract class SynchronizedTextMeshProBase<TComponentService> : SynchronizedComponent<TComponentService, SynchronizedTextMeshProChangeType>
        where TComponentService : Singleton<TComponentService>, ISynchronizedComponentService
    {
        ...
        protected override bool HasChanges(SynchronizedTextMeshProChangeType changeFlags)
        {
            return changeFlags != SynchronizedTextMeshProChangeType.None;
        }

        protected override SynchronizedTextMeshProChangeType CalculateDeltaChanges()
        {
            SynchronizedTextMeshProChangeType change = SynchronizedTextMeshProChangeType.None;
            string newText = this.textMesh.text;
            if (previousText != newText)
            {
                change |= SynchronizedTextMeshProChangeType.Text;
                previousText = newText;
            }
            if (!previousProperties.IsCached(textMesh))
            {
                change |= SynchronizedTextMeshProChangeType.FontAndPlacement;
        ...
        {
            SendDeltaChanges(endpoints, SynchronizedTextMeshProChangeType.FontAndPlacement | SynchronizedTextMeshProChangeType.Text);
        }

        protected override void SendDeltaChanges(IEnumerable<SocketEndpoint> endpoints, SynchronizedTextMeshProChangeType changeFlags)
        {
        ...
        protected virtual void WriteText(SynchronizedTextMeshProChangeType changeType, BinaryWriter message)
        {
