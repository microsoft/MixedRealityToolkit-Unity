...
namespace Microsoft.MixedReality.Toolkit.Tests.Experimental
{
    ...
    public class BoundsControlTests
    {
        ...
        public IEnumerator ScaleViaNearInteration()
        {
            ...
            yield return PlayModeTestUtilities.MoveHand(initialHandPosition, frontRightCornerPos, ArticulatedHandPose.GestureId.OpenSteadyGrabPoint, Handedness.Right, inputSimulationService);
