...
{
    /// <summary>
    /// Component that can be added to any <see href="https://docs.unity3d.com/ScriptReference/GameObject.html">GameObject</see> with a <see href="https://docs.unity3d.com/ScriptReference/Collider.html">Collider</see> to Modifies either the <see cref="MRTKPrefix.Input.IMixedRealityCursor"/> reacts when focused by a <see cref="MRTKPrefix.Input.IMixedRealityPointer"/>.
    /// </summary>
