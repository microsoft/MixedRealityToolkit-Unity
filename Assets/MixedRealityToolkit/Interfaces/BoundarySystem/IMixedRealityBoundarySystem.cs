...
namespace Microsoft.MixedReality.Toolkit.Core.Interfaces.BoundarySystem
{
    ...
    public interface IMixedRealityBoundarySystem : IMixedRealityEventSystem, IMixedRealityEventSource
    {
        ...
        /// </summary>
        /// <remarks>
        /// The ceiling is defined as a <see cref="UnityEngine.GameObject"/> positioned <see cref="BoundaryHeight"/> above the floor.
        /// </remarks>
        ...
        /// <summary>
        /// Gets the <see cref="UnityEngine.GameObject"/> that represents the user's floor.
        /// </summary>
        /// <returns>The floor visualization object or null if one does not exist.</returns>
        GameObject GetFloorVisualization();

        /// <summary>
        /// Gets the <see cref="UnityEngine.GameObject"/> that represents the user's play area.
        /// </summary>
        /// <returns>The play area visualization object or null if one does not exist.</returns>
        GameObject GetPlayAreaVisualization();

        /// <summary>
        /// Gets the <see cref="UnityEngine.GameObject"/> that represents the user's tracked area.
        /// </summary>
        ...
        /// <summary>
        /// Gets the <see cref="UnityEngine.GameObject"/> that represents the user's boundary walls.
        /// </summary>
        ...
        /// <summary>
        /// Gets the <see cref="UnityEngine.GameObject"/> that represents the upper surface of the user's boundary.
        /// </summary>
