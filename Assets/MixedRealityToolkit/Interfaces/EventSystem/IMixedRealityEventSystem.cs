...
namespace Microsoft.MixedReality.Toolkit.Core.Interfaces.Events
{
    ...
    public interface IMixedRealityEventSystem : IMixedRealityService
    {
        ...
        /// <summary>
        /// Registers a <see cref="UnityEngine.GameObject"/> to listen for events from this Event System.
        /// </summary>
        /// <param name="listener"><see cref="UnityEngine.GameObject"/> to add to <see cref="EventListeners"/>.</param>
        void Register(GameObject listener);

        /// <summary>
        /// Unregisters a <see cref="UnityEngine.GameObject"/> from listening for events from this Event System.
        /// </summary>
        /// <param name="listener"><see cref="UnityEngine.GameObject"/> to remove from <see cref="EventListeners"/>.</param>
