...
{
    [CreateAssetMenu(fileName = "LightingControlSettings", menuName = "Pixie/LightingControlSettings")]
    public class LightingControlSetting : ScriptableObject
    {
        public DeviceTypeEnum Device { get { return device; } }
        ...
        [Header("Device Type")]
        private DeviceTypeEnum device = DeviceTypeEnum.None;
