...
namespace Microsoft.MixedReality.Toolkit.Internal.Devices.OpenVR
{
    ...
    public class WindowsMixedRealityOpenVRMotionController : GenericOpenVRController
    {
        ...
        public override MixedRealityInteractionMapping[] DefaultLeftHandedInteractions => new[]
        {
            ...
            new MixedRealityInteractionMapping(2, "Grip Press", AxisType.SingleAxis, DeviceInputType.ButtonPress, ControllerMappingLibrary.AXIS_11),
            ...
            new MixedRealityInteractionMapping(10, "Thumbstick Position", AxisType.DualAxis, DeviceInputType.ThumbStick, ControllerMappingLibrary.AXIS_1, ControllerMappingLibrary.AXIS_2, true),
        ...
        public override MixedRealityInteractionMapping[] DefaultRightHandedInteractions => new[]
        {
            ...
            new MixedRealityInteractionMapping(5, "Grip Press", AxisType.SingleAxis, DeviceInputType.ButtonPress, ControllerMappingLibrary.AXIS_12),
            ...
            new MixedRealityInteractionMapping(10, "Thumbstick Position", AxisType.DualAxis, DeviceInputType.ThumbStick, ControllerMappingLibrary.AXIS_4, ControllerMappingLibrary.AXIS_5, true),
