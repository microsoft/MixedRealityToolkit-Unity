...
namespace Microsoft.MixedReality.Toolkit.Internal.Devices.OpenVR
{
    public class ViveWandController : GenericOpenVRController
    {
        ...
        public new static readonly MixedRealityInteractionMapping[] DefaultLeftHandedInteractions =
        {
            ...
            new MixedRealityInteractionMapping(5, "Grip Press", AxisType.SingleAxis, DeviceInputType.Grip, MixedRealityInputAction.None, KeyCode.None, ControllerMappingLibrary.MIXEDREALITY_OPENVR_AXIS11),
        ...
        public new static readonly MixedRealityInteractionMapping[] DefaultRightHandedInteractions =
        {
            ...
            new MixedRealityInteractionMapping(5, "Grip Press", AxisType.SingleAxis, DeviceInputType.Grip, MixedRealityInputAction.None, KeyCode.None, ControllerMappingLibrary.MIXEDREALITY_OPENVR_AXIS12),
            new MixedRealityInteractionMapping(10, "Trackpad Position", AxisType.DualAxis, DeviceInputType.Touchpad, MixedRealityInputAction.None),
