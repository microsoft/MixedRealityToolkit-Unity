...
namespace Microsoft.MixedReality.Toolkit.Internal.Devices.OpenVR
{
    public class OculusTouchController : GenericOpenVRController
    {
        ...
        public static readonly MixedRealityInteractionMapping[] DefaultOculusTouchInteractions =
        {
            ...
            new MixedRealityInteractionMapping(2, "Trigger Near Touch",AxisType.Digital, DeviceInputType.TriggerNearTouch, MixedRealityInputAction.None),
            new MixedRealityInteractionMapping(3, "Trigger Touched", AxisType.Digital, DeviceInputType.TriggerTouch, MixedRealityInputAction.None),
            new MixedRealityInteractionMapping(4, "Trigger Selected", AxisType.Digital, DeviceInputType.Select, MixedRealityInputAction.None),
            new MixedRealityInteractionMapping(5, "Grip",AxisType.SingleAxis, DeviceInputType.Grip, MixedRealityInputAction.None),
            new MixedRealityInteractionMapping(6, "Grip Press",AxisType.Digital, DeviceInputType.GripPress, MixedRealityInputAction.None),
            new MixedRealityInteractionMapping(7, "Grip Touch",AxisType.Digital, DeviceInputType.GripTouch, MixedRealityInputAction.None),
            new MixedRealityInteractionMapping(8, "Thumbstick Position", AxisType.DualAxis, DeviceInputType.ThumbStick, MixedRealityInputAction.None),
            new MixedRealityInteractionMapping(9, "Thumbstick Touch ", AxisType.Digital, DeviceInputType.ThumbStickTouch, MixedRealityInputAction.None),
            new MixedRealityInteractionMapping(10, "Thumbstick Near Touch ", AxisType.Digital, DeviceInputType.ThumbStickNearTouch, MixedRealityInputAction.None),
            ...
            new MixedRealityInteractionMapping(12, "Primary Button Touch ", AxisType.Digital, DeviceInputType.ButtonTouch, MixedRealityInputAction.None),
            new MixedRealityInteractionMapping(13, "Primary Button Press ", AxisType.Digital, DeviceInputType.ButtonPress, MixedRealityInputAction.None),
            new MixedRealityInteractionMapping(14, "Secondary Button Touch ", AxisType.Digital, DeviceInputType.SecondaryButtonTouch, MixedRealityInputAction.None),
            new MixedRealityInteractionMapping(15, "Secondary Button Press ", AxisType.Digital, DeviceInputType.SecondaryButtonPress, MixedRealityInputAction.None),
            new MixedRealityInteractionMapping(16, "Thumbrest Near Touch ", AxisType.Digital, DeviceInputType.ThumbNearTouch, MixedRealityInputAction.None),
            new MixedRealityInteractionMapping(17, "Thumbrest Touch ", AxisType.Digital, DeviceInputType.ThumbTouch, MixedRealityInputAction.None),
            new MixedRealityInteractionMapping(18, "Start Pressed", AxisType.Digital, DeviceInputType.Start, MixedRealityInputAction.None),
        };
