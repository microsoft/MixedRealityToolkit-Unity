...
namespace Microsoft.MixedReality.Toolkit.Internal.Devices.OpenVR
{
    ...
    {
        public HTCViveController(ControllerState controllerState, Handedness controllerHandedness, IMixedRealityInputSource inputSource, Dictionary<DeviceInputType, MixedRealityInteractionMapping> interactions = null) : this()
        {
