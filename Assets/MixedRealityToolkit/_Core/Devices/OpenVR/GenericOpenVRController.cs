...
namespace Microsoft.MixedReality.Toolkit.Internal.Devices.OpenVR
{
    ...
    {
        public GenericOpenVRController(ControllerState controllerState, Handedness controllerHandedness, IMixedRealityInputSource inputSource, Dictionary<DeviceInputType, IInteractionMapping> interactions = null) : this()
        {
