...
namespace Microsoft.MixedReality.Toolkit.Internal.Devices.WindowsMixedReality
{
    ...
    {
        // TODO
        public HoloLensClicker(ControllerState controllerState, Handedness controllerHandedness, IMixedRealityInputSource inputSource, Dictionary<DeviceInputType, IInteractionMapping> interactions = null) : this()
        {
