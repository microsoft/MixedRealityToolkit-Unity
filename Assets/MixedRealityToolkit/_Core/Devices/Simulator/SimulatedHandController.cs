...
namespace Microsoft.MixedReality.Toolkit.Internal.Devices.Simulator
{
    ...
    {
        public SimulatedHandController(ControllerState controllerState, Handedness controllerHandedness, IMixedRealityInputSource inputSource, List<IInteractionMapping> interactions = null) : this()
        {
