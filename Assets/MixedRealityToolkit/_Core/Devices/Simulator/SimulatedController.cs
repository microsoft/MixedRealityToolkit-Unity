...
namespace Microsoft.MixedReality.Toolkit.Internal.Devices.Simulator
{
    ...
    {
        public SimulatedController(ControllerState controllerState, Handedness controllerHandedness, IMixedRealityInputSource inputSource, Dictionary<DeviceInputType, MixedRealityInteractionMapping> interactions = null) : this()
        {
