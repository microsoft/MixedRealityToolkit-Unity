...
namespace Microsoft.MixedReality.Toolkit.Internal.Devices.WindowsGaming
{
    ...
    {
        public RacingWheelController(ControllerState controllerState, Handedness controllerHandedness, IMixedRealityInputSource inputSource, List<IInteractionMapping> interactions = null) : this()
        {
