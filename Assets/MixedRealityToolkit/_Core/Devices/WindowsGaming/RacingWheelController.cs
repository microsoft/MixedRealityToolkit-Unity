...
namespace Microsoft.MixedReality.Toolkit.Internal.Devices.WindowsGaming
{
    ...
    {
        public RacingWheelController(ControllerState controllerState, Handedness controllerHandedness, IMixedRealityInputSource inputSource, Dictionary<DeviceInputType, MixedRealityInteractionMapping> interactions = null) : this()
        {
