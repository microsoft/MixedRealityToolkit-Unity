...
namespace Microsoft.MixedReality.Toolkit.Internal.Utilities.UX
{
    ...
    /// </summary>
    public struct InteractiveGestureData
    {
        ...
        public InteractiveGestureData(Vector3 alignmentVector, float maxDistance, bool flipDirectionOnCameraForward)
        {
    ...
    public class InteractiveGestureControl : MonoBehaviour
    {
        /// <summary>
        ...
        /// <returns></returns>
        public InteractiveGestureData GetGestureData(Vector3 alignmentVector, float maxDistance, bool flipDirecationOnCameraForward)
        {
            InteractiveGestureData data = new InteractiveGestureData(alignmentVector, maxDistance, flipDirecationOnCameraForward);
