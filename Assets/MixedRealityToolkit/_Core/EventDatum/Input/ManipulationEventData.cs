...
namespace Microsoft.MixedReality.Toolkit.Internal.EventDatum.Input
{
    ...
    public class ManipulationEventData : InputEventData
    {
        ...
        public void Initialize(IMixedRealityInputSource inputSource, MixedRealityInputAction inputAction, Vector3 cumulativeDelta)
        {
        ...
        /// <param name="inputAction"></param>
        /// <param name="cumulativeDelta"></param>
        public void Initialize(IMixedRealityInputSource inputSource, Handedness handedness, MixedRealityInputAction inputAction, Vector3 cumulativeDelta)
        {
