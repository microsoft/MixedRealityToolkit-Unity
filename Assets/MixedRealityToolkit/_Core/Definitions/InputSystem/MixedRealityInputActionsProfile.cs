...
namespace Microsoft.MixedReality.Toolkit.Internal.Definitions.InputSystem
{
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "Mixed Reality Toolkit/Mixed Reality Input Actions Profile", fileName = "InputActionProfile", order = 1)]
    public class MixedRealityInputActionsProfile : ScriptableObject
    {
        ...
        [SerializeField]
        [Tooltip("The action to use for pointing events.")]
        ...
        [SerializeField]
        [Tooltip("The action to use for pointing events.")]
        private InputAction holdAction = null;
        /// <summary>
        /// The action to use for pointing events.
        /// </summary>
        public InputAction HoldAction => holdAction;
    }
}