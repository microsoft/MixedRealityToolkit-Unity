...
namespace Microsoft.MixedReality.Toolkit
{
    ...
    public sealed class ExtendsAttribute : SystemTypeAttribute
    {
        ...
        private bool includeBaseType = default;
        ...
        public ExtendsAttribute(Type baseType, TypeGrouping grouping, bool includeBaseType = false) : base(baseType, grouping)
        {
            BaseType = baseType;
            this.includeBaseType = includeBaseType;
        }
