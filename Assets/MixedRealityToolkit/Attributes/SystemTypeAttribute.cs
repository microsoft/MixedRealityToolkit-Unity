...
namespace MRTKPrefix
{
    ...
    /// a <see cref="MRTKPrefix.Utilities.SystemType"/> with the Unity inspector.
    /// </summary>
    public abstract class SystemTypeAttribute : PropertyAttribute
    {
        /// <summary>
        /// Gets or sets grouping of selectable classes. Defaults to <see cref="MRTKPrefix.Utilities.TypeGrouping.ByNamespaceFlat"/> unless explicitly specified.
        /// </summary>
        ...
        /// <param name="grouping">Gets or sets grouping of selectable classes. Defaults to <see cref="MRTKPrefix.Utilities.TypeGrouping.ByNamespaceFlat"/> unless explicitly specified.</param>
