...
{
    /// <summary>
    /// The EdgeUtilities class provides functionality for working with <see cref="MRTKPrefix.Boundary.Edge"/> objects.
    /// </summary>
    public static class EdgeUtilities
    {
        ...
        /// <summary>
        /// Returns the point at which two <see cref="MRTKPrefix.Boundary.Edge"/> values intersect.
        /// </summary>
