...
namespace Microsoft.MixedReality.Toolkit.Core.Utilities.Editor
{
    ...
    {
        /// <summary>
        /// Set the saved <see cref="string"/> from the <see cref="UnityEditor.EditorPrefs"/>.
        /// </summary>
        ...
        /// <summary>
        /// Set the saved <see cref="bool"/> from the <see cref="UnityEditor.EditorPrefs"/>.
        /// </summary>
        /// <param name="key"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Set the saved <see cref="float"/> from the <see cref="UnityEditor.EditorPrefs"/>.
        /// </summary>
        /// <param name="key"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Set the saved <see cref="int"/> from the <see cref="UnityEditor.EditorPrefs"/>.
        /// </summary>
        /// <param name="key"></param>
        /// <param name="value"></param>
        ...
        /// <summary>
        /// Get the saved <see cref="string"/> from the <see cref="UnityEditor.EditorPrefs"/>.
        /// </summary>
        /// <param name="key"></param>
        ...
        /// <summary>
        /// Get the saved <see cref="bool"/> from the <see cref="UnityEditor.EditorPrefs"/>.
        /// </summary>
        /// <param name="key"></param>
        /// <param name="defaultValue"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Get the saved <see cref="float"/> from the <see cref="UnityEditor.EditorPrefs"/>.
        /// </summary>
        /// <param name="key"></param>
        /// <param name="defaultValue"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Get the saved <see cref="int"/> from the <see cref="UnityEditor.EditorPrefs"/>.
        /// </summary>
        /// <param name="key"></param>
        /// <param name="defaultValue"></param>
        /// <returns></returns>
