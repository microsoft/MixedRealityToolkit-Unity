...
{
    /// <summary>
    /// Custom property drawer for <see cref="Microsoft.MixedReality.Toolkit.Core.Attributes.Vector3RangeAttribute"/> decorated <see cref="UnityEngine.Vector3"/> values rendered in the inspector.
    /// </summary>
