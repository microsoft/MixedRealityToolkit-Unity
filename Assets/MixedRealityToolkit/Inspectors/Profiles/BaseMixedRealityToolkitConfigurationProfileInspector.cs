...
namespace Microsoft.MixedReality.Toolkit.Core.Inspectors.Profiles
{
    ...
    public abstract class BaseMixedRealityToolkitConfigurationProfileInspector : BaseMixedRealityProfileInspector
    {
        ...
        protected virtual void Awake()
        {
            ...
            {
                logoLightTheme = (Texture2D)AssetDatabase.LoadAssetAtPath($"{MixedRealityEditorSettings.MixedRealityToolkit_RelativeFolderPath}{MixedRealityEditorSettings.MixedRealityCoreFolder}/Resources/Textures/MRTK_Logo_Black.png", typeof(Texture2D));
            }

            if (logoDarkTheme == null)
            {
                logoDarkTheme = (Texture2D)AssetDatabase.LoadAssetAtPath($"{MixedRealityEditorSettings.MixedRealityToolkit_RelativeFolderPath}{MixedRealityEditorSettings.MixedRealityCoreFolder}/Resources/Textures/MRTK_Logo_White.png", typeof(Texture2D));
            }
        }
