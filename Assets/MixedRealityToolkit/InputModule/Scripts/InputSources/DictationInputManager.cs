...
namespace MixedRealityToolkit.InputModule.InputSources
{
    ...
    public class DictationInputManager : Singleton<DictationInputManager>, IInputSource
    {
        ...
        private void LateUpdate()
        {
            ...
            {
                hasFailed = true;
                InputManager.RaiseDictationError(Instance, "Dictation recognizer has failed!");
            }
        }
        ...
        public static IEnumerator StartRecording(GameObject listener = null, float initialSilenceTimeout = 5f, float autoSilenceTimeout = 20f, int recordingTime = 10)
        {
            ...
            {
                hasListener = true;
                InputManager.PushModalInputHandler(listener);
            }
            ...
            {
                InputManager.RaiseDictationError(Instance, "Dictation recognizer failed to start!");
                yield break;
            }
        ...
        private static void DictationRecognizer_DictationHypothesis(string text)
        {
            ...
            InputManager.RaiseDictationHypothesis(Instance, dictationResult);
        }
        ...
        private static void DictationRecognizer_DictationResult(string text, ConfidenceLevel confidence)
        {
            ...
            InputManager.RaiseDictationResult(Instance, dictationResult);
        }
        ...
        private static void DictationRecognizer_DictationComplete(DictationCompletionCause cause)
        {
            ...
            InputManager.RaiseDictationComplete(Instance, dictationResult, dictationAudioClip);
            textSoFar = null;
            dictationResult = string.Empty;
        }
        ...
        private static void DictationRecognizer_DictationError(string error, int hresult)
        {
            ...
            InputManager.RaiseDictationError(Instance, dictationResult);
            textSoFar = null;
            dictationResult = string.Empty;
        }
