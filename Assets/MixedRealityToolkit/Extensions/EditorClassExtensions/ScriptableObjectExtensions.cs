...
{
    /// <summary>
    /// Extensions for <see cref="UnityEngine.ScriptableObject"/>s
    /// </summary>
    public static class ScriptableObjectExtensions
    {
        /// <summary>
        /// Creates, saves, and then opens a new asset for the target <see cref="UnityEngine.ScriptableObject"/>.
        /// </summary>
        /// <param name="scriptableObject"><see cref="UnityEngine.ScriptableObject"/> you want to create an asset file for.</param>
        ...
        /// </summary>
        /// <typeparam name="T">The Type of <see cref="UnityEngine.ScriptableObject"/> you're wanting to find instances of.</typeparam>
