...
{
    public class BaseSpatialAwarenessMeshObserver : BaseSpatialAwarenessObserver, IMixedRealitySpatialAwarenessMeshObserver
    {
        ...
        public BaseSpatialAwarenessMeshObserver(string name, uint priority, ScriptableObject profile) : base(name, priority, profile)
        {
        ...
        /// <inheritdoc />
        public SpatialMeshDisplayOptions DisplayOption { get; set; } = SpatialMeshDisplayOptions.None;
