...
namespace Microsoft.MixedReality.Toolkit.InputSystem
{
    ...
    public class MixedRealityInputManager : MixedRealityEventManager, IMixedRealityInputSystem
    {
        ...
        /// <inheritdoc />
        public void RaiseOnInputPressed(IMixedRealityInputSource source, Handedness handedness, InputType inputType, double pressAmount)
        {
            // Create input event
        ...
        /// <inheritdoc />
        public void Raise6DofInputChanged(IMixedRealityInputSource source, InputType inputType, Tuple<Vector3, Quaternion> inputData)
        {
            // Create input event
        ...
        /// <inheritdoc />
        public void Raise6DofInputChanged(IMixedRealityInputSource source, Handedness handedness, InputType inputType, Tuple<Vector3, Quaternion> inputData)
        {
            // Create input event
