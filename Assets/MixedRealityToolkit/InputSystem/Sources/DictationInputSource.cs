...
namespace Microsoft.MixedReality.Toolkit.InputSystem.Sources
{
    ...
    public class DictationInputSource : BaseGenericInputSource
    {
        ...
        public DictationInputSource(InputAction hypothesisAction, InputAction resultAction, InputAction completeAction, InputAction errorAction) : base("Dictation")
        {
            source = this;
