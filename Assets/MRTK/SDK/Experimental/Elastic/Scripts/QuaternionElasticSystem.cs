...
namespace Microsoft.MixedReality.Toolkit.Experimental.Physics
{
    ...
    {
        /// <summary>
        /// An extended/improved version of the typical Quaternion lerp; this version
        /// includes a "short way" argument, which controls whether the slerping algorithm
        /// uses the shortest path or the naive path.
        /// </summary>
        /// <param name="p"> Beginning quaternion </param>
        /// <param name="q"> Ending quaternion </param>
        /// <param name="t"> Lerp factor </param>
        /// <param name="shortWay"></param>
        /// <returns></returns>
