...
{
    public class LookAndPinchPointer : GenericPointer,
        IMixedRealityQueryablePointer
    {
        ...
        public LookAndPinchPointer(GazeProvider gazeProvider, string pointerName, IMixedRealityInputSource inputSourceParent, LayerMask[] raycastLayerMasks, float pointerExtent, Transform gazeTransform, BaseRayStabilizer stabilizer)
