...
namespace Microsoft.MixedReality.Toolkit.XRSDK
{
    ...
    public class XRSDKBoundarySystem : BaseCoreSystem, IMixedRealityBoundarySystem
    {
        ...
        private void CalculateBoundaryBounds()
        {
            ...
            if (inputSubsystem.TryGetBoundaryPoints(boundaryGeometry) && boundaryGeometry.Count > 0)
            {
