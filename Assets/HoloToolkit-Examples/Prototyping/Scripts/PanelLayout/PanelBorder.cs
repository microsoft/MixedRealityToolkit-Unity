...
[ExecuteInEditMode]
public class PanelBorder : MonoBehaviour
{
    ...
    private void UpdatePosition()
    {
        ...
        transform.localPosition = Background.transform.localPosition + newPosition;
    }
    ...
    private void UpdateSize()
    {
        ...
        {
            case BorderTypes.Top:
                newScale = new Vector3(Background.transform.localScale.x + Thickness / BasePixelScale, Thickness / BasePixelScale, Depth / BasePixelScale);
                break;
            case BorderTypes.Right:
                newScale = new Vector3(Thickness / BasePixelScale, Background.transform.localScale.y + (Thickness * 2) / BasePixelScale, Depth / BasePixelScale);
                break;
            case BorderTypes.Bottom:
                newScale = new Vector3(Background.transform.localScale.x + Thickness / BasePixelScale, Thickness / BasePixelScale, Depth / BasePixelScale);
                break;
