...
namespace HoloToolkit.Unity.InputModule.Examples.Grabbables
{
    ...
    {
        public static ControllerReleaseData GetThrowReleasedVelocityAndAngularVelocity(this Rigidbody _rigidbody,
            Vector3 centerOfMassOfRigidbody, InteractionSourcePose poseInfo)
        {
            ...
            Debug.Log(" SetVal = ControllerVelocity ( " + controllerVelocity + ") controllerAngVel ((" +
                      controllerAngularVelocity + ") * -1 )" + "  * dist (" + dist + ")");
