...
namespace HoloToolkit.Unity.Examples
{
    public class OptimizeSceneforDeviceType : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                // Show IHMD camera
                cameraHoloLens.SetActive(false);
                cameraImmersiveHMD.SetActive(true);
            ...
            {
                // Show HoloLens camera, hide floor and table
                cameraHoloLens.SetActive(true);
                cameraImmersiveHMD.SetActive(false);
