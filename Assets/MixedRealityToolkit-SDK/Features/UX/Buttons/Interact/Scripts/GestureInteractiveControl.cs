...
namespace Interact
{
    ...
    public class GestureInteractiveControl : MonoBehaviour
    {
        ...
        /// </summary>
        [Tooltip("CurrentPercent will always be 0-1")]
        ...
        protected void UpdateGesture()
        {
            ...
            switch (GestureData)
            {
				...
				case GestureDataType.CameraAligned:
                    ...
                    CurrentDistance = GetDistanceByAlignmentVector(AlignmentVector);
                    break;  
                default:
                    break;
            }
            ...
            if (!ClampPercentage)
            {
                CurrentPercentage = Mathf.Abs(CurrentDistance) / MaxGestureDistance;
            }
        }
		...
		protected float GetDistanceByAlignmentVector(Vector3 alignment)
        {
            ...
            {
                return Vector3.Dot(DirectionVector, MainCamera.transform.right);
            }
            ...
            {
                return Vector3.Dot(DirectionVector, MainCamera.transform.up);
            }
            ...
            {
                return Vector3.Dot(DirectionVector, MainCamera.transform.forward);
            }
            ...
            return CurrentDistance = Vector3.Dot(DirectionVector, MainCamera.transform.right);
        }
