...
{
    [CustomEditor(typeof(ColorThemeWidget))]
    public class ColorThemeWidgetEditor : ShaderPropertyEditor
    {
        private ColorThemeWidget widget;
        private SerializedObject widgetRef;
        protected SerializedProperty blendData;

        private ColorThemeWidget Inspector;
        ...
        {
            Inspector = (ColorThemeWidget)target;
            widget = (ColorThemeWidget)target;
        ...
        protected override void SelectProperty()
        {
            ...
            {
                Inspector.ShaderPropertyName = ColorAbstraction.DefaultColor;
            }
        }
    }
}
