...
namespace Microsoft.MixedReality.Toolkit.SDK.UX
{
    ...
    public class BoundingBoxGizmoHandle : MonoBehaviour, IMixedRealityInputHandler, IMixedRealitySourceStateHandler
    {
        ...
        private Vector3 GetHandPosition(uint sourceId)
        {
            ...
            inputDownEventData.InputSource.Pointers[0].TryGetPointerPosition(out handPosition);
            return handPosition;
        }
        private Quaternion GetHandOrientation(uint sourceId)
        {
            Quaternion handOrientation = Quaternion.identity;
            inputDownEventData.InputSource.Pointers[0].TryGetPointerRotation(out handOrientation);
