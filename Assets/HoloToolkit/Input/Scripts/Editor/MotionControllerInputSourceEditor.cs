...
{
    [CustomEditor(typeof(MotionControllerInputSource))]
    public class MotionControllerInputSourceEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                customMappingsProperty.arraySize = Enum.GetNames(typeof(MotionControllerMappingTypes)).Length;
        ...
        private static void ShowList(SerializedProperty list)
        {
            ...
            for (int i = 0; i < list.arraySize; i++)
            {
                ...
                EditorGUILayout.LabelField(((MotionControllerMappingTypes)i).ToString());
