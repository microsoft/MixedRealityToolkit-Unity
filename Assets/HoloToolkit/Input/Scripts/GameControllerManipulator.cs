...
namespace HoloToolkit.Unity
{
    ...
    public class GameControllerManipulator : MonoBehaviour
    {
        ...
        private GameObject lastManipulatedObject;
        ...
        void Update()
        {
            ...
            if (!MoveGazeTarget)
                ...
                go = lastManipulatedObject ?? GazeManager.Instance.FocusedObject;
            ...
            if (stickInFrontOfMe || x != 0 || y != 0 || z != 0 || rz != 0 || ry != 0 || rx != 0)
                lastManipulatedObject = go;
#if !UNITY_EDITOR
        else
           lastManipulatedObject = null; //easier to test in Unity this way
#endif
        }
