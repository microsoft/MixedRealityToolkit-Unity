...
namespace HoloToolkit.Unity
{
    ...
    public class WorldAnchorManager : Singleton<WorldAnchorManager>
    {
        ...
        /// <summary>
        /// Attaches an anchor immediately to the specified GameObject.  
        /// If the anchor store has an anchor with the specified name it will load the anchor, 
        /// otherwise a new anchor will be saved under the specified name.  
        /// If no anchor name is provided, the name of the anchor will be the same as the GameObject.
        /// </summary>
        /// <param name="gameObjectToAnchor">The GameObject to attach the anchor to.</param>
        /// <param name="anchorName">Name of the anchor.  If none provided, the name of the GameObject will be used.</param>
        /// <returns>The the newly attached anchor.</returns>
        public UnityEngine.XR.WSA.WorldAnchor AttachAnchorImmediate(GameObject gameObjectToAnchor, string anchorName = null)
        {
#if !UNITY_WSA || UNITY_EDITOR
            Debug.LogWarning("World Anchor Manager does not work for this build. AttachAnchorImmediate will not be called.");
            return null;
#else
            if (gameObjectToAnchor == null)
            {
            ...
            return gameObjectToAnchor.GetComponent<WorldAnchor>();
#endif
        }

        /// <summary>
        /// Removes the anchor from the game object immediately and deletes the anchor
        ...
        private void RemoveAnchorImmediate(string anchorName, GameObject gameObjectToUnanchor)
        {
