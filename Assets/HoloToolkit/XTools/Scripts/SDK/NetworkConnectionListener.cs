...
public class NetworkConnectionListener : Listener {
  ...
  internal NetworkConnectionListener(global::System.IntPtr cPtr, bool cMemoryOwn) : base(XToolsClientPINVOKE.NetworkConnectionListener_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          XToolsClientPINVOKE.delete_NetworkConnectionListener(swigCPtr);
        }
  ...
  public virtual void OnConnected(NetworkConnection connection) {
    if (SwigDerivedClassHasMethod("OnConnected", swigMethodTypes0)) XToolsClientPINVOKE.NetworkConnectionListener_OnConnectedSwigExplicitNetworkConnectionListener(swigCPtr, NetworkConnection.getCPtr(connection)); else XToolsClientPINVOKE.NetworkConnectionListener_OnConnected(swigCPtr, NetworkConnection.getCPtr(connection));
  }

  public virtual void OnConnectFailed(NetworkConnection connection) {
    if (SwigDerivedClassHasMethod("OnConnectFailed", swigMethodTypes1)) XToolsClientPINVOKE.NetworkConnectionListener_OnConnectFailedSwigExplicitNetworkConnectionListener(swigCPtr, NetworkConnection.getCPtr(connection)); else XToolsClientPINVOKE.NetworkConnectionListener_OnConnectFailed(swigCPtr, NetworkConnection.getCPtr(connection));
  }

  public virtual void OnDisconnected(NetworkConnection connection) {
    if (SwigDerivedClassHasMethod("OnDisconnected", swigMethodTypes2)) XToolsClientPINVOKE.NetworkConnectionListener_OnDisconnectedSwigExplicitNetworkConnectionListener(swigCPtr, NetworkConnection.getCPtr(connection)); else XToolsClientPINVOKE.NetworkConnectionListener_OnDisconnected(swigCPtr, NetworkConnection.getCPtr(connection));
  }

  public virtual void OnMessageReceived(NetworkConnection connection, NetworkInMessage message) {
    if (SwigDerivedClassHasMethod("OnMessageReceived", swigMethodTypes3)) XToolsClientPINVOKE.NetworkConnectionListener_OnMessageReceivedSwigExplicitNetworkConnectionListener(swigCPtr, NetworkConnection.getCPtr(connection), NetworkInMessage.getCPtr(message)); else XToolsClientPINVOKE.NetworkConnectionListener_OnMessageReceived(swigCPtr, NetworkConnection.getCPtr(connection), NetworkInMessage.getCPtr(message));
    if (XToolsClientPINVOKE.SWIGPendingException.Pending) throw XToolsClientPINVOKE.SWIGPendingException.Retrieve();
  }

  public NetworkConnectionListener() : this(XToolsClientPINVOKE.new_NetworkConnectionListener(), true) {
    SwigDirectorConnect();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    XToolsClientPINVOKE.NetworkConnectionListener_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3);
  }
