...
public class SyncListener : Listener {
  ...
  internal SyncListener(global::System.IntPtr cPtr, bool cMemoryOwn) : base(XToolsClientPINVOKE.SyncListener_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          XToolsClientPINVOKE.delete_SyncListener(swigCPtr);
        }
  ...
  public virtual void OnSyncChangesBegin() {
    if (SwigDerivedClassHasMethod("OnSyncChangesBegin", swigMethodTypes0)) XToolsClientPINVOKE.SyncListener_OnSyncChangesBeginSwigExplicitSyncListener(swigCPtr); else XToolsClientPINVOKE.SyncListener_OnSyncChangesBegin(swigCPtr);
  }

  public virtual void OnSyncChangesEnd() {
    if (SwigDerivedClassHasMethod("OnSyncChangesEnd", swigMethodTypes1)) XToolsClientPINVOKE.SyncListener_OnSyncChangesEndSwigExplicitSyncListener(swigCPtr); else XToolsClientPINVOKE.SyncListener_OnSyncChangesEnd(swigCPtr);
  }

  public SyncListener() : this(XToolsClientPINVOKE.new_SyncListener(), true) {
    SwigDirectorConnect();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    XToolsClientPINVOKE.SyncListener_director_connect(swigCPtr, swigDelegate0, swigDelegate1);
  }
