...
public class SessionManagerListener : Listener {
  ...
  internal SessionManagerListener(global::System.IntPtr cPtr, bool cMemoryOwn) : base(XToolsClientPINVOKE.SessionManagerListener_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public override void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          XToolsClientPINVOKE.delete_SessionManagerListener(swigCPtr);
        }
  ...
  public virtual void OnCreateSucceeded(Session newSession) {
    if (SwigDerivedClassHasMethod("OnCreateSucceeded", swigMethodTypes0)) XToolsClientPINVOKE.SessionManagerListener_OnCreateSucceededSwigExplicitSessionManagerListener(swigCPtr, Session.getCPtr(newSession)); else XToolsClientPINVOKE.SessionManagerListener_OnCreateSucceeded(swigCPtr, Session.getCPtr(newSession));
  }

  public virtual void OnCreateFailed(XString reason) {
    if (SwigDerivedClassHasMethod("OnCreateFailed", swigMethodTypes1)) XToolsClientPINVOKE.SessionManagerListener_OnCreateFailedSwigExplicitSessionManagerListener(swigCPtr, XString.getCPtr(reason)); else XToolsClientPINVOKE.SessionManagerListener_OnCreateFailed(swigCPtr, XString.getCPtr(reason));
  }

  public virtual void OnSessionAdded(Session newSession) {
    if (SwigDerivedClassHasMethod("OnSessionAdded", swigMethodTypes2)) XToolsClientPINVOKE.SessionManagerListener_OnSessionAddedSwigExplicitSessionManagerListener(swigCPtr, Session.getCPtr(newSession)); else XToolsClientPINVOKE.SessionManagerListener_OnSessionAdded(swigCPtr, Session.getCPtr(newSession));
  }

  public virtual void OnSessionClosed(Session session) {
    if (SwigDerivedClassHasMethod("OnSessionClosed", swigMethodTypes3)) XToolsClientPINVOKE.SessionManagerListener_OnSessionClosedSwigExplicitSessionManagerListener(swigCPtr, Session.getCPtr(session)); else XToolsClientPINVOKE.SessionManagerListener_OnSessionClosed(swigCPtr, Session.getCPtr(session));
  }

  public virtual void OnUserJoinedSession(Session session, User newUser) {
    if (SwigDerivedClassHasMethod("OnUserJoinedSession", swigMethodTypes4)) XToolsClientPINVOKE.SessionManagerListener_OnUserJoinedSessionSwigExplicitSessionManagerListener(swigCPtr, Session.getCPtr(session), User.getCPtr(newUser)); else XToolsClientPINVOKE.SessionManagerListener_OnUserJoinedSession(swigCPtr, Session.getCPtr(session), User.getCPtr(newUser));
  }

  public virtual void OnUserLeftSession(Session session, User user) {
    if (SwigDerivedClassHasMethod("OnUserLeftSession", swigMethodTypes5)) XToolsClientPINVOKE.SessionManagerListener_OnUserLeftSessionSwigExplicitSessionManagerListener(swigCPtr, Session.getCPtr(session), User.getCPtr(user)); else XToolsClientPINVOKE.SessionManagerListener_OnUserLeftSession(swigCPtr, Session.getCPtr(session), User.getCPtr(user));
  }

  public virtual void OnUserChanged(Session session, User user) {
    if (SwigDerivedClassHasMethod("OnUserChanged", swigMethodTypes6)) XToolsClientPINVOKE.SessionManagerListener_OnUserChangedSwigExplicitSessionManagerListener(swigCPtr, Session.getCPtr(session), User.getCPtr(user)); else XToolsClientPINVOKE.SessionManagerListener_OnUserChanged(swigCPtr, Session.getCPtr(session), User.getCPtr(user));
  }

  public virtual void OnServerConnected() {
    if (SwigDerivedClassHasMethod("OnServerConnected", swigMethodTypes7)) XToolsClientPINVOKE.SessionManagerListener_OnServerConnectedSwigExplicitSessionManagerListener(swigCPtr); else XToolsClientPINVOKE.SessionManagerListener_OnServerConnected(swigCPtr);
  }

  public virtual void OnServerDisconnected() {
    if (SwigDerivedClassHasMethod("OnServerDisconnected", swigMethodTypes8)) XToolsClientPINVOKE.SessionManagerListener_OnServerDisconnectedSwigExplicitSessionManagerListener(swigCPtr); else XToolsClientPINVOKE.SessionManagerListener_OnServerDisconnected(swigCPtr);
  }

  public SessionManagerListener() : this(XToolsClientPINVOKE.new_SessionManagerListener(), true) {
    SwigDirectorConnect();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    XToolsClientPINVOKE.SessionManagerListener_director_connect(swigCPtr, swigDelegate0, swigDelegate1, swigDelegate2, swigDelegate3, swigDelegate4, swigDelegate5, swigDelegate6, swigDelegate7, swigDelegate8);
  }
