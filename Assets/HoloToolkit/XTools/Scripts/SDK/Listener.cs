...
public class Listener : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          XToolsClientPINVOKE.delete_Listener(swigCPtr);
        }
  ...
  public void UnregisterAll() {
    XToolsClientPINVOKE.Listener_UnregisterAll(swigCPtr);
  }

  public bool IsRegistered() {
    bool ret = XToolsClientPINVOKE.Listener_IsRegistered(swigCPtr);
    return ret;
  }

  public Listener() : this(XToolsClientPINVOKE.new_Listener(), true) {
  }
