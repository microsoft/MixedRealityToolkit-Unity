...
public class Log : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          XToolsClientPINVOKE.delete_Log(swigCPtr);
        }
  ...
  public static void Info(string message) {
    XToolsClientPINVOKE.Log_Info(message);
  }

  public static void Warning(string message) {
    XToolsClientPINVOKE.Log_Warning(message);
  }

  public static void Error(string message) {
    XToolsClientPINVOKE.Log_Error(message);
  }

  public Log() : this(XToolsClientPINVOKE.new_Log(), true) {
  }
