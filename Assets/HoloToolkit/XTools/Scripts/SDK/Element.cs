...
public class Element : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          XToolsClientPINVOKE.delete_Element(swigCPtr);
        }
  ...
  public virtual ElementType GetElementType() {
    ElementType ret = (ElementType)XToolsClientPINVOKE.Element_GetElementType(swigCPtr);
    return ret;
  }

  public virtual long GetGUID() {
    long ret = XToolsClientPINVOKE.Element_GetGUID(swigCPtr);
    return ret;
  }

  public virtual XString GetName() {
    global::System.IntPtr cPtr = XToolsClientPINVOKE.Element_GetName(swigCPtr);
    XString ret = (cPtr == global::System.IntPtr.Zero) ? null : new XString(cPtr, true);
    return ret; 
  }

  public virtual Element GetParent() {
    global::System.IntPtr cPtr = XToolsClientPINVOKE.Element_GetParent(swigCPtr);
    Element ret = (cPtr == global::System.IntPtr.Zero) ? null : new Element(cPtr, true);
    return ret; 
  }

  public virtual bool IsValid() {
    bool ret = XToolsClientPINVOKE.Element_IsValid(swigCPtr);
    return ret;
  }
