...
public class LogWriter : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          XToolsClientPINVOKE.delete_LogWriter(swigCPtr);
        }
  ...
  public virtual void WriteLogEntry(LogSeverity severity, string message) {
    if (SwigDerivedClassHasMethod("WriteLogEntry", swigMethodTypes0)) XToolsClientPINVOKE.LogWriter_WriteLogEntrySwigExplicitLogWriter(swigCPtr, (int)severity, message); else XToolsClientPINVOKE.LogWriter_WriteLogEntry(swigCPtr, (int)severity, message);
    if (XToolsClientPINVOKE.SWIGPendingException.Pending) throw XToolsClientPINVOKE.SWIGPendingException.Retrieve();
  }

  public LogWriter() : this(XToolsClientPINVOKE.new_LogWriter(), true) {
    SwigDirectorConnect();
  }
  ...
  private void SwigDirectorConnect() {
    ...
    XToolsClientPINVOKE.LogWriter_director_connect(swigCPtr, swigDelegate0);
  }
