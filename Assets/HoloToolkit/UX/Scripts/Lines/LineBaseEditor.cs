...
namespace HoloToolkit.Unity.UX
{
    ...
    public class LineBaseEditor : MRTKEditor
    {
        ...
        protected virtual StepModeEnum EditorStepMode
        {
            get { return StepModeEnum.Interpolated; }
        }
        ...
        protected override void DrawCustomFooter()
        {
            ...
            {
                linePreviewResolutionSelected =
                    EditorGUILayout.IntSlider("Preview resolution", linePreviewResolutionSelected, 3, 100);
                ...
                {
                    lineManualUpVectorLength =
                        EditorGUILayout.Slider("Manual Up Vector Length", lineManualUpVectorLength, 1f, 10f);
        ...
        protected void DrawLineRotations(LineBase line, int numSteps)
        {
            ...
            for (int i = 1; i < numSteps; i++)
            {
                ...
                Handles.ArrowHandleCap(0, currentPos, Quaternion.LookRotation(rotation * Vector3.forward), arrowSize,
                    EventType.Repaint);
                Handles.color = Color.Lerp(lineVelocityColor, Handles.xAxisColor, 0.75f);
                Handles.ArrowHandleCap(0, currentPos, Quaternion.LookRotation(rotation * Vector3.right), arrowSize,
                    EventType.Repaint);
                Handles.color = Color.Lerp(lineVelocityColor, Handles.yAxisColor, 0.75f);
                Handles.ArrowHandleCap(0, currentPos, Quaternion.LookRotation(rotation * Vector3.up), arrowSize,
                    EventType.Repaint);
            }
        }
