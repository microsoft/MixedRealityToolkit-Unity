...
namespace HoloToolkit.Unity
{
    ...
    public partial class UAudioManager : UAudioManagerBase<AudioEvent>
    {
        ...
        /// <param name="messageToSend">The Message to Send to the GameObject when the sound has finished playing.</param>
        public void PlayEvent(string eventName, GameObject emitter, string messageToSend = null)
        {
            PlayEvent(
                eventName,
                emitter,
                            ...
                            string messageToSend = null)
        {
            ...
            PlayEvent(currentEvent, emitter, primarySource, secondarySource, messageToSend);
        }
        ...
        private void PlayEvent(AudioEvent audioEvent,
                            ...
                            string messageToSend = null)
        {
            ActiveEvent tempEvent = new ActiveEvent(audioEvent, emitter, primarySource, secondarySource, messageToSend);
