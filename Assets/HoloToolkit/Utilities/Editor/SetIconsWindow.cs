...
public class SetIconsWindow : EditorWindow
{
    ...
    {
        // wanneer het een wide is..  de size halveren voor height..?
    ...
    private Texture2D CloneAndResizeToTexture(Texture2D texture, Vector2 iconSize)
    {
        ...
        //EditorUtility.CompressTexture(clone, TextureFormat.ARGB32, TextureCompressionQuality.Best);
        
        //clone.Compress(true);
        //TextureScale.Point(clone, (int)iconSize.x, (int)iconSize.y);
