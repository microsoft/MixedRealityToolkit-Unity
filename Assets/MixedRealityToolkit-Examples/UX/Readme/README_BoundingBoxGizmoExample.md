...
This script also contains two events, `BoundingBoxRig.Activated` and `BoundingBoxRig.Deactivated`, which can be listened to know when the bounding box rig is activated or deactivated by the user.
