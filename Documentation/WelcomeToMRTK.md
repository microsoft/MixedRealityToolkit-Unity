...
> [!CAUTION]
> The Unity development journey currently uses **MRTK version 2.4.1** and **Unity 2019.4**. If you're working with other configurations it's still recommended that you start there, but you can also refer to the [installation instructions](Installation.md).
