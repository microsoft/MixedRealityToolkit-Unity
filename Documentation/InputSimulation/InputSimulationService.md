...
Eye tracking simulation can be enabled by checking the __Simulate Eye Position__ option in the
...
[This document](../EyeTracking/EyeTracking_BasicSetup.md#simulating-eye-tracking-in-the-unity-editor)
describes how eye tracking simulation works.