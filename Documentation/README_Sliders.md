...
A Slider with specificied step increments is currently an experimental feature and a demo can be in the example scene under `MRTK/Examples/Experimental/StepSlider/`
