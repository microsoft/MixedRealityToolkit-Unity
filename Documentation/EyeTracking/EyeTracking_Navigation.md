...
[mrtk_eyes_03_Navigation.unity](/Assets/MixedRealityToolkit.Examples/Demos/EyeTracking/Scenes/mrtk_eyes_03_Navigation.unity)
scene. 
...
You can start off from the example provided in [mrtk_eyes_03_Navigation.unity](/Assets/MixedRealityToolkit.Examples/Demos/EyeTracking/Scenes/mrtk_eyes_03_Navigation.unity).
This example uses a [TextMesh](href:https://docs.unity3d.com/ScriptReference/TextMesh.html) component to allow for flexibly loading and formatting new text.
To enable auto scroll, simply add the following two scripts to your collider component of the textbox:

### Scroll_RectTransf
To scroll through a [TextMesh](href:https://docs.unity3d.com/ScriptReference/TextMesh.html) or more generally speaking a [RectTransform](href:https://docs.unity3d.com/ScriptReference/RectTransform.html) component you can use the *Scroll_RectTransf* script. 
If you want to scroll through a texture instead of a [RectTransform](href:https://docs.unity3d.com/ScriptReference/RectTransform.html), use _Scroll_Texture_ instead of _Scroll_RectTransf_.
In the following, the parameters of _Scroll_RectTransf_ that are available in the Unity Editor are explained in more detail:

Parameters | Description 
:---- | :----
LimitPanning | If enabled, will stop the scrollable content at its boundary.
RectTransfToNavigate | Reference to the [RectTransform](href:https://docs.unity3d.com/ScriptReference/RectTransform.html) to scroll in.
RefToViewport | Reference to the parent [RectTransform](href:https://docs.unity3d.com/ScriptReference/RectTransform.html) of the scrollable content to determine the correct offset and boundary.
...
[BaseEyeFocusHandler](/Documentation/EyeTracking/EyeTracking_TargetSelection.md#use-eye-gaze-specific-baseeyefocushandler) 
...
For content rendered to a [Texture](href: https://docs.unity3d.com/ScriptReference/Texture.html) (e.g., a photo, streamed data), simply add the_PanZoom_Texture_ script.
For a [RectTransform](href:https://docs.unity3d.com/ScriptReference/RectTransform.html) use _PanZoom_RectTransf_.
...
To enable this behavior, simply add the *OnLookAt_RotateByEyeGaze* script to the part of your GameObject with a [Collider](href:https://docs.unity3d.com/ScriptReference/Collider.html) component.
...
Alternatively, we added an example in [mrtk_eyes_03_Navigation.unity](/Assets/MixedRealityToolkit.Examples/Demos/EyeTracking/Scenes/mrtk_eyes_03_Navigation.unity)
