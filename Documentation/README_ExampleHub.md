...
## Run the Example Hub App on a Hololens
To run the MRTK Examples Hub app directly on a Hololens 1 or Hololens 2, download the [App Package](https://github.com/microsoft/MixedRealityToolkit-Unity/releases/tag/v2.4.0).


## Run the Example Hub in Unity
