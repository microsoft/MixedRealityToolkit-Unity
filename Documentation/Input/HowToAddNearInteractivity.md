...
1. Ensure a [SpherePointer](Pointers.md#spherepointer) is registered in the *MRTK Pointer profile*.
    ...
    The default grab point will query for nearby objects in a sphere around the grab point. By replacing the prefab with the `Hololens2ShellGrabPointer` prefab
