...
> [!NOTE]
>This installation check (when the application start) if there is the AR Foundation components on the scene, if not their are automaticaly add to make it work with ARCore and ARKit.
>If you need to set a specific behaviour, you should add the components you need by your self. 
