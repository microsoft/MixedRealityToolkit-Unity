...
|  [![Hand Physics Service](Documentation/Images/HandPhysics/MRTK_UX_HandPhysics_Main.jpg)](Documentation/README_ProgressIndicator.md) [Hand Physics Service](Documentation/README_ProgressIndicator.md) | [![Scrolling Collection](Documentation/Images/ScrollingCollection/MRTK_UX_ScrollingCollection_Main.jpg)](Documentation/README_Dialog.md) [Scrolling Collection [Experimental]](Documentation/README_Dialog.md) | [![Dock](Documentation/Images/Dock/MRTK_UX_Dock_Main.png)](Assets/MRTK/SDK/Experimental/HandCoach/README_HandCoach.md) [Dock [Experimental]](Assets/MRTK/SDK/Experimental/HandCoach/README_HandCoach.md) |
| Visual indicator for communicating data process or operation | UI for asking for user's confirmation or acknowledgement  | Component that helps guide the user when the gesture has not been taught |
