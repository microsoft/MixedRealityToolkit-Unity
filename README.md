...
[![](External/ReadMeImages/MixedRealityStack-Apps.png)](https://developer.microsoft.com/en-us/windows/mixed-reality/academy)
[![](External/ReadMeImages/MixedRealityStack-MRTK-Unity.png)](https://github.com/Microsoft/MixedRealityCompanionKit)
[![](External/ReadMeImages/MixedRealityStack-MRTK.png)](https://github.com/Microsoft/MixedRealityToolkit)
[![](External/ReadMeImages/MixedRealityStack-UWP.png)](https://developer.microsoft.com/en-us/windows/mixed-reality)
...
# Required Software
| ![Windows 10 Creators Update](External/ReadMeImages/MRTK170802_Short_17.png) [Windows 10 FCU](https://www.microsoft.com/software-download/windows10)| ![Unity](External/ReadMeImages/MRTK170802_Short_18.png) [Unity 3D](https://unity3d.com/get-unity/download/archive)| ![Visual Studio 2017](External/ReadMeImages/MRTK170802_Short_19.png) [Visual Studio 2017](http://dev.windows.com/downloads)| ![Simulator (optional)](External/ReadMeImages/MRTK170802_Short_20.png) [Simulator (optional)](https://go.microsoft.com/fwlink/?linkid=852626)|
| :--- | :--- | :--- | :--- |
...
| ![Hololens Emulator(optional)](External/ReadMeImages/MotionControllerTest_Teleport.png) Motion Controller tests | ![Hololens Emulator(optional)](External/ReadMeImages/MRTK_MotionController_GrabMechanics.jpg) Grab Mechanics demo | ![Hololens Emulator(optional)](External/ReadMeImages/SceneOcclusion.png) Scene occulsion demo |
...
Check out the [Examples](https://github.com/Microsoft/MixedRealityToolkit-Unity/tree/master/Assets/HoloToolkit-Examples) folder for more details.
