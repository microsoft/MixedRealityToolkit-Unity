...
| ![Discover](External/ReadMeImages/icon_academy.png) [Discover](https://docs.microsoft.com/en-us/windows/mixed-reality/)| ![Design](External/ReadMeImages/icon_design.png) [Design](https://docs.microsoft.com/en-us/windows/mixed-reality/design)| ![Develop](External/ReadMeImages/icon_development.png) [Develop](https://docs.microsoft.com/en-us/windows/mixed-reality/development)| ![Distribute)](External/ReadMeImages/icon_community.png) [Distribute](https://docs.microsoft.com/en-us/windows/mixed-reality/implementing-3d-app-launchers)|
| :--------------------- | :----------------- | :------------------ | :------------------------ |
...
| ![Azure Spatial Anchors](External/ReadMeImages/icon_academy.png) [Azure Spatial Anchors](https://docs.microsoft.com/en-us/azure/spatial-anchors/)| ![Speech Services](External/ReadMeImages/icon_design.png) [Speech Services](https://docs.microsoft.com/en-us/azure/cognitive-services/speech-service/)| ![Vision Services](External/ReadMeImages/icon_development.png) [Vision Services](https://docs.microsoft.com/en-us/azure/cognitive-services/computer-vision/)|       
| :------------------------| :--------------------- | :---------------------- | 
