...
![LeapMotionIntroGif](../../Documentation/Images/CrossPlatform/LeapMotion/LeapHandsGif3.gif)
...
1. Prepare MRTK project for Leap Motion
    ...
    ![LeapMotionUpdateCSCFile](../../Documentation/Images/CrossPlatform/LeapMotion/LeapMotionConfigureCSCFile2.png)
...
1. Adding the Leap Motion Data Provider
    ...
    ![LeapMotionProfileClone](../../Documentation/Images/CrossPlatform/LeapMotion/LeapProfileClone.png)

    - Select the **Input** Configuration Profile

    ![InputConfigurationProfile](../../Documentation/Images/CrossPlatform/LeapMotion/LeapInputConfigurationProfile.png)

    - Select **Clone** in the input system profile to enable modification.

    ![LeapMotionInputProfileClone](../../Documentation/Images/CrossPlatform/LeapMotion/LeapCloneInputSystemProfile.png)
    ...
    ![LeapAddDataProvider](../../Documentation/Images/CrossPlatform/LeapMotion/LeapAddDataProvider.png)

    - Select **Clone** to change the default Leap Motion settings.

    ![LeapDataProviderPreClone](../../Documentation/Images/CrossPlatform/LeapMotion/LeapDeviceManagerProfileBeforeClone.png)
    ...
    :-------------------------:|:-------------------------:
    ![LeapHeadsetGif](../../Documentation/Images/CrossPlatform/LeapMotion/LeapHeadsetOrientationExampleMetacarpals.gif)  |  ![LeapDeskGif](../../Documentation/Images/CrossPlatform/LeapMotion/LeapDeskOrientationExampleMetacarpals.gif)
    ![LeapHeadsetInspector](../../Documentation/Images/CrossPlatform/LeapMotion/LeapDeviceManagerHeadset.png) |     ![LeapDeskInspector](../../Documentation/Images/CrossPlatform/LeapMotion/LeapDeviceManagerDesk.png)
