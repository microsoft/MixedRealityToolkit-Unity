...
- Examine the value of **Api Compatibility Level**
    ...
    ![API Compatibility Level](../Documentation/Images/ReleaseNotes/ApiCompatibilityLevel.png)

- If set to **.NET Standard 2.0**, delete the **Dependencies\net46** folder
- If set to **.NET 4.x**, delete the **Dependencies\netstandard20** folder

    ![Duplicate dependencies](../Documentation/Images/ReleaseNotes/DuplicateDependencies.png)
...
![Depth reprojection method](../Documentation/Images/CameraSystem/WMRCameraSettingsReprojectionMethod.png)
