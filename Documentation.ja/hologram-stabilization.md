...
Windows Mixed Reality プラットフォームは、プラットフォーム上でホログラムを安定させるための[参考資料](https://docs.microsoft.com/windows/mixed-reality/hologram-stability)を提供しています。開発者がホログラムの視覚体験を改善するために利用できる主要なツールはいくつかあります。
...
Windows Mixed Reality デバイス上で動作するデバイス エンドポイントと OS のバージョンに応じて、Late-Stage Reprojection アルゴリズムはピクセル単位または [安定化平面]　(https://docs.microsoft.com/windows/mixed-reality/hologram-stability#stabilization-plane) を介して実行されます。
...
プラットフォームと共有する正確なデプス バッファーを作成できない場合、別の形式の LSR は安定化平面を使用します。シーン内のすべてのホログラムにはある程度の安定化が適用されますが、目的の平面にあるホログラムには最大のハードウェア安定化が適用されます。平面の点と法線は、[Unity で提供される API の](https://docs.microsoft.com/windows/mixed-reality/focus-point-in-unity)  *HolographicSettings.SetFocusPointForFrame* を介してプラットフォームに提供されます。
...
- [HoloLens の環境に関する考慮事項](https://docs.microsoft.com/windows/mixed-reality/environment-considerations-for-hololens)
- [Windows Mixed Reality におけるホログラムの安定性](https://docs.microsoft.com/windows/mixed-reality/hologram-stability)
- [Unity のフォーカス ポイント](https://docs.microsoft.com/windows/mixed-reality/focus-point-in-unity)
- [Unity での座標系](https://docs.microsoft.com/windows/mixed-reality/coordinate-systems-in-unity)
- [Unity での永続化](https://docs.microsoft.com/windows/mixed-reality/persistence-in-unity)
- [Mixed Reality のパフォーマンスについて](https://docs.microsoft.com/windows/mixed-reality/understanding-performance-for-mixed-reality)
- [Unity のパフォーマンスに関する推奨事項](https://docs.microsoft.com/windows/mixed-reality/performance-recommendations-for-unity)
