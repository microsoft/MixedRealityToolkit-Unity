...
2. Navigate the Inspector panel to the camera system section and ensure that **Enable Camera System** is checked.
    ...
    ![Enabling the camera system](../../Documentation/Images/CameraSystem/EnableCameraSystem.png)
...
3. Select the camera system implementation. The default class implementation provided by the MRTK is the `MixedRealityCameraSystem`.
    ...
    ![Select camera system implementation](../../Documentation/Images/CameraSystem/SelectCameraSystemType.png)

4. Select the desired configuration profile

    ![Select camera system profile](../../Documentation/Images/CameraSystem/SelectCameraProfile.png)

## Configuring the camera system

### Settings providers

![Camera Settings Providers](../../Documentation/Images/CameraSystem/CameraSettingsProviders.png)
...
![Camera Display Settings](../../Documentation/Images/CameraSystem/CameraDisplaySettings.png)
