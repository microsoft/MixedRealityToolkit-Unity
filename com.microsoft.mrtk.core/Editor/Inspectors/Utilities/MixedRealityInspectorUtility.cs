...
namespace Microsoft.MixedReality.Toolkit.Editor
{
    ...
    public static class MixedRealityInspectorUtility
    {
        ...
        public static bool RenderMixedRealityToolkitLogo()
        {
            ...
            {
                EditorGUILayout.LabelField("Microsoft Mixed Reality Toolkit", ProductNameStyle);
                GUILayout.Space(3f);
                return false;
            }
        }
        ...
        // /// <summary>
        // /// Draws a dropdown with all available profiles of profileType.
        // /// </summary>
        ...
        // /// <summary>
        // /// Draws a dropdown with all available profiles of types contained in the array profileTypes.
        // /// </summary>
        // /// <returns>True if property was changed.</returns>
