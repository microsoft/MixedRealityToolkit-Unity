...
{
    /// <summary>
    /// An interface for binding a class according to a <see cref="DataBindingProfile"/>. 
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    public interface IDataBindable
    {
        ...
        /// <returns>Whether any binding was found and processed.</returns>
        bool ConfigureFromBindingProfile(string[] dataSourceTypes, DataBindingProfile[] bindingProfiles);
    }
}
